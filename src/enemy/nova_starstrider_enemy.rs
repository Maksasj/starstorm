...
#[derive(Component)]
pub struct NovaStarstriderEnemy {
    pub moving_speed: f32
}

impl NovaStarstriderEnemy {
    pub fn new() -> Self {
        NovaStarstriderEnemy { 
            moving_speed: 100.0 
        }
    }
}
...
#[derive(Bundle)]
pub struct NovaStarstriderEnemyBundle {
    name: Name,
...
impl NovaStarstriderEnemyBundle {
    pub fn new(asset_server: &Res<SpriteSheet>, pos: Vec2) -> Self {
        ...
        NovaStarstriderEnemyBundle { 
            name: Name::new("NovaStarstriderEnemy"),
            sprite_bundle: SpriteSheetBundle {
                sprite: sprite,
...
impl Enemy for NovaStarstriderEnemy {
