...
#[derive(Component)]
pub struct AndromedaAscendantEnemy {
...
#[derive(Bundle)]
pub struct AndromedaAscendantEnemyBundle {
    name: Name,
...
impl Enemy for AndromedaAscendantEnemy {
